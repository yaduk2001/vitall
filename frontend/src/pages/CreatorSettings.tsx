                ...
                <div className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col fixed h-full z-20 top-16 shadow-none">
                    ...
                    <nav className="flex-1 px-4">
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a className="flex items-center space-x-3 px-4 py-3 rounded-lg font-medium text-white bg-red-600 shadow-lg shadow-red-900/20 transition-all border-l-4 border-transparent" href="/creator/settings">
                    ...
                    <div className="max-w-7xl mx-auto space-y-8 pb-12">
                        <div className="flex items-end justify-between border-b border-gray-200 pb-6">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-1">Manage your channel preferences.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl border border-gray-200 shadow-sm max-w-2xl">
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input type="text" value={user?.fullName || ''} readOnly className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-500" />
                                </div>
                                <div className="pt-4 border-t border-gray-100">
                                    <h4 className="text-sm font-bold text-gray-900 mb-2">Account Type</h4>
                                    <p className="text-sm text-gray-500">{getCreatorLabel()}</p>
                                </div>
                                <div className="pt-4">
